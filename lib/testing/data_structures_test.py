...
from data_structures import get_names, get_spiciest_foods, print_spicy_foods, \
                            ...
                            average_heat_level, create_spicy_food
...
class TestDataStructures:
    ...
    def test_get_names(self):
        ...
        names = get_names(TestDataStructures.SPICY_FOODS)
        print(names)  # Add this line to print the result
        assert names == ['Green Curry', 'Buffalo Wings', 'Mapo Tofu']
    ...
    def test_create_spicy_food(self):
        ...
        assert new_spicy_foods == expected_result